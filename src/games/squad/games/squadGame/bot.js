...
export default class Character extends Component {
  ...
  loop = () => {
    ...
    if (Store.mode === 'play') {
      if (Util.rect2parent(player, parentEl, direction)) Store.moveCharacter(this.props.gameId, this.props.charId);
      var world = {
      ...
      if (setDirection) {
        if (setDirection.left) Store.changeDirection(this.props.gameId, this.props.charId, 'left');
        else if (setDirection.right) Store.changeDirection(this.props.gameId, this.props.charId, 'right');
        else if (setDirection.up) Store.changeDirection(this.props.gameId, this.props.charId, 'up');
        else if (setDirection.down) Store.changeDirection(this.props.gameId, this.props.charId, 'down');
      }
    }
    this.getCollectives();
  ...
  render() {
    switch (this.props.type) {
      case 'gnome1':
        return (
          <div id={'bt' + this.props.charId + '-' + this.props.gameId}>
            <Gnome1
