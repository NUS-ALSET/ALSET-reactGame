...
var _concrete = require('../../commonGameAssets/tiles/concrete.jpg');
...
var Concrete = (_temp = _class = function (_Component) {
  _inherits(Concrete, _Component);

  function Concrete(props) {
    _classCallCheck(this, Concrete);

    return _possibleConstructorReturn(this, (Concrete.__proto__ || Object.getPrototypeOf(Concrete)).call(this, props));
  }

  _createClass(Concrete, [{
