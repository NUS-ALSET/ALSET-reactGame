...
var Character = (_temp = _class = function (_Component) {
  ...
  function Character(props) {
    ...
    _this.loop = function () {
      if (!document.getElementById('bt' + _this.props.charId)) return;
      ...
      if (_gemCollector2.default.mode == 'play') {
        ...
        var world = {
          ...
          collectives: _gemCollector2.default.collectives
        };
        if (_this.props.showCodeEditor) {
          try {
            var setDirection = eval('(function(world){' + _gemCollector2.default.func + '}(world))');
          } catch (err) {
        ...
        if (setDirection) {
          if (setDirection.left) _gemCollector2.default.changeDirection(_this.props.charId, 'left');else if (setDirection.right) _gemCollector2.default.changeDirection(_this.props.charId, 'right');else if (setDirection.up) _gemCollector2.default.changeDirection(_this.props.charId, 'up');else if (setDirection.down) _gemCollector2.default.changeDirection(_this.props.charId, 'down');
        }
      }
