...
var Controls = (_temp = _class = function (_Component) {
  ...
  _createClass(Controls, [{
    key: 'loop',
    value: function loop() {
      if (_squad2.default.time == 0 && _squad2.default.mode != 'restart' && _squad2.default.mode != 'pause') {
        _squad2.default.mode = 'pause';
        if (this.props.onEnd) {
          var player = _squad2.default.score[0] > _squad2.default.score[1] ? 'player1' : 'player2';
    ...
    value: function startCountDown() {
      setInterval(function () {
        if (_squad2.default.mode == 'play' && _squad2.default.time > 0) _squad2.default.time--;
      }, 1000);
    }
  }, {
    key: 'pauseResumeGame',
    value: function pauseResumeGame() {
      if (_squad2.default.mode == 'pause') {
        _squad2.default.mode = 'play';
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _squad2.default.time == 0 && _react2.default.createElement(
          'div',
          { style: {
              position: 'absolute',
              background: '#7eca84',
          ...
          _react2.default.createElement(
            ...
            _squad2.default.score[0] > _squad2.default.score[1] ? 'Player 1 Win!!!' : 'Player 2 Win!!!'
          ),
          _react2.default.createElement(
            'button',
        ...
        _react2.default.createElement(
          ...
          _squad2.default.mode == 'play' ? 'Pause' : 'Resume'
        )
      );
    }
  }]);
