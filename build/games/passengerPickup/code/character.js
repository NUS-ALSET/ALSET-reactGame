...
var Character = (_temp = _class = function (_Component) {
  ...
  function Character(props) {
    ...
    _this.loop = function () {
      if (!document.getElementById('pl' + _this.props.charId + '-' + _this.props.gameId)) return;
      var player = document.getElementById('pl' + _this.props.charId + '-' + _this.props.gameId).childNodes[0];
      var parentEl = document.getElementById('pl' + _this.props.charId + '-' + _this.props.gameId).parentElement;
      var direction = _passengerPickup2.default.direction[_this.props.gameId][_this.props.charId];
      if (_index2.default.rect2parent(player, parentEl, direction) && _passengerPickup2.default.mode == 'play') _passengerPickup2.default.moveCharacter(_this.props.gameId, _this.props.charId);
      _this.getCollectives();
      _this.loadOffPassengers();
      if (_passengerPickup2.default.mode == 'restart') {
        _passengerPickup2.default.restartCharacter(_this.props.gameId, _this.props.charId);
      }
    };
    ...
    document.addEventListener('keydown', function (e) {
      if (_passengerPickup2.default.currentControllable[_this.props.gameId] == _this.props.charId && _passengerPickup2.default.mode == 'play') {
        switch (e.key) {
          case _this.props.keys.left:
            _passengerPickup2.default.changeDirection(_this.props.gameId, _this.props.charId, 'left');
            break;
          case _this.props.keys.right:
            _passengerPickup2.default.changeDirection(_this.props.gameId, _this.props.charId, 'right');
            break;
          case _this.props.keys.up:
            _passengerPickup2.default.changeDirection(_this.props.gameId, _this.props.charId, 'up');
            break;
          case _this.props.keys.down:
            _passengerPickup2.default.changeDirection(_this.props.gameId, _this.props.charId, 'down');
            break;
          case _this.props.keys.action:
            _passengerPickup2.default.switchPlayer(_this.props.gameId);
            break;
          default:
            break;
        }
    ...
    value: function getCollectives() {
      ...
      Array.from(collectives).forEach(function (collective) {
        if (_index2.default.rect2Rect(collective, player)) {
          ...
          _passengerPickup2.default.removeCollective(_this2.props.gameId, _this2.props.charId, collectiveId);
        }
      });
    }
  }, {
    key: 'loadOffPassengers',
    value: function loadOffPassengers() {
      ...
      if (_index2.default.rect2Rect(halt, player)) {
        _passengerPickup2.default.loadOutPassengers(this.props.gameId, this.props.charId);
      }
    }
  }, {
      ...
      switch (this.props.type) {
        case 'gnome1':
          return _react2.default.createElement(
            'div',
            { id: 'pl' + this.props.charId + '-' + this.props.gameId },
            _react2.default.createElement(_Gnome2.default, {
              position: _passengerPickup2.default.position[this.props.gameId][this.props.charId],
              direction: _passengerPickup2.default.direction[this.props.gameId][this.props.charId]
            })
          );
        case 'gnome2':
          return _react2.default.createElement(
