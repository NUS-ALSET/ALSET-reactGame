...
var Bot = (_temp = _class = function (_Component) {
  ...
  function Bot(props) {
    ...
    _this.loop = function () {
      ...
      if (_passengerPickup2.default.mode == 'play') {
        if (_index2.default.rect2parent(player, parentEl, direction)) _passengerPickup2.default.moveCharacter(_this.props.gameId, _this.props.charId);
        var world = {
          player: _passengerPickup2.default.position[_this.props.gameId][_this.props.charId],
          freePlaces: _passengerPickup2.default.freePlaces[_this.props.gameId][_this.props.charId],
          collectives: _passengerPickup2.default.collectives[_this.props.gameId]
        };
        if (_this.props.showCodeEditor) {
          try {
            var setDirection = eval('(function(world){' + _passengerPickup2.default.func + '}(world))');
          } catch (err) {
        ...
        if (setDirection) {
          if (setDirection.left) _passengerPickup2.default.changeDirection(_this.props.gameId, _this.props.charId, 'left');else if (setDirection.right) _passengerPickup2.default.changeDirection(_this.props.gameId, _this.props.charId, 'right');else if (setDirection.up) _passengerPickup2.default.changeDirection(_this.props.gameId, _this.props.charId, 'up');else if (setDirection.down) _passengerPickup2.default.changeDirection(_this.props.gameId, _this.props.charId, 'down');
        }
      }
