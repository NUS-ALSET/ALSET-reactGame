...
var Collectives = (_temp = _class = function (_Component) {
  ...
  function Collectives() {
    ...
    _this.loop = function () {
      _passengerPickup2.default.generateCollectives(_this.props.gameId, _this.props.min, _this.props.max, _this.props.size);
    };
      ...
      switch (this.props.type) {
        case 'coin':
          return _react2.default.createElement(
            'div',
            null,
            _passengerPickup2.default.collectives[this.props.gameId].map(function (collective, index) {
